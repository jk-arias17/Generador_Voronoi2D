...
En caso de obtener una malla en la cual se vea que un agregado se encuentre adentro de una matriz, se recomienda bajar el área objetivo de matriz con el fin de solucionar dicha discrepancia.
