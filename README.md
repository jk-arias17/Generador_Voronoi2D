...
Para ejecutar el programa, únicamente es necesario modificar las líneas 16 a 19, correspondientes a la base y la altura del dominio de análisis, al porcentaje de agregados deseado con respecto a la mezcla y al área objetivo de la matriz.
