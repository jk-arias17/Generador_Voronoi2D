...
Posteriormente, basta con modificar las líneas 16 a 20, correspondientes a la base y la altura del dominio de análisis, al porcentaje de agregados deseado con respecto a la mezcla,al área objetivo de la matriz y los porcentajes por cada tipo de agregado
